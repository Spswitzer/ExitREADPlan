...
qrystudentPlan <- odbc::dbGetQuery(con, 
  ...
  SELECT
   ...
   --,tStudentNeedFocusArea.StudentNeedFocusAreaID --Not using this could use for grouping
   --,tFocusArea.FocusAreaName
   --,tStudentNeedFocusArea.FocusAreaID
   --,tStudentNeedFocusArea.FocusAreaRanking
   --,tStudentNeedFocusArea.StartDate AS studentNeedFocusStart
  --,tStudentNeedFocusArea.EndDate AS studentNeedFocusEnd --all NA
   ,tInstruction.ImplementedDate
   ,tInstruction.CompletedDate
   ,tInstruction.InstructionID
   ,tInstruction.InstructionDescription

  --,tInstruction.CompletedDate -- all NA
